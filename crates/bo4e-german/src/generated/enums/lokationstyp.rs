...
impl From<bo4e_core::enums::LocationType> for Lokationstyp {
    fn from(v: bo4e_core::enums::LocationType) -> Self {
        match v {
            ...
            bo4e_core::enums::LocationType::MeteringLocation => {
                Lokationstyp::Messlokation
            }
            ...
            bo4e_core::enums::LocationType::TechnicalResource => {
                Lokationstyp::TechnischeRessource
            }
...
impl From<Lokationstyp> for bo4e_core::enums::LocationType {
    fn from(v: Lokationstyp) -> Self {
        match v {
            ...
            _ => panic!("Unknown {} variant", stringify!(Lokationstyp)),
        }
    }
}
