...
impl From<bo4e_core::enums::TenderType> for Ausschreibungstyp {
    fn from(v: bo4e_core::enums::TenderType) -> Self {
        ...
        match v {
            bo4e_core::enums::TenderType::PrivateLaw => Ausschreibungstyp::Privatrechtlich,
            bo4e_core::enums::TenderType::PublicLaw => Ausschreibungstyp::Oeffentlichrechtlich,
...
impl From<Ausschreibungstyp> for bo4e_core::enums::TenderType {
    fn from(v: Ausschreibungstyp) -> Self {
        #[allow(unreachable_patterns)]
        match v {
            Ausschreibungstyp::Privatrechtlich => bo4e_core::enums::TenderType::PrivateLaw,
            Ausschreibungstyp::Oeffentlichrechtlich => bo4e_core::enums::TenderType::PublicLaw,
