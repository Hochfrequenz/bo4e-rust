...
impl From<bo4e_core::enums::TariffFeature> for Tarifmerkmal {
    fn from(v: bo4e_core::enums::TariffFeature) -> Self {
        ...
        match v {
            ...
            bo4e_core::enums::TariffFeature::ConstructionPower => Tarifmerkmal::Baustromprodukt,
            bo4e_core::enums::TariffFeature::BuildingLighting => Tarifmerkmal::Hauslichtprodukt,
            bo4e_core::enums::TariffFeature::HeatingPower => Tarifmerkmal::Heizstromprodukt,
...
impl From<Tarifmerkmal> for bo4e_core::enums::TariffFeature {
    fn from(v: Tarifmerkmal) -> Self {
        ...
        match v {
            ...
            Tarifmerkmal::Baustromprodukt => bo4e_core::enums::TariffFeature::ConstructionPower,
            Tarifmerkmal::Hauslichtprodukt => bo4e_core::enums::TariffFeature::BuildingLighting,
            Tarifmerkmal::Heizstromprodukt => bo4e_core::enums::TariffFeature::HeatingPower,
