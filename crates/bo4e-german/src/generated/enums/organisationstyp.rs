...
impl From<bo4e_core::enums::OrganizationType> for Organisationstyp {
    fn from(v: bo4e_core::enums::OrganizationType) -> Self {
        match v {
            ...
            bo4e_core::enums::OrganizationType::MunicipalInstitution => {
                Organisationstyp::B2A
            }
            bo4e_core::enums::OrganizationType::GovernmentAuthority => {
                Organisationstyp::B2G
            }
...
impl From<Organisationstyp> for bo4e_core::enums::OrganizationType {
    fn from(v: Organisationstyp) -> Self {
        match v {
            ...
            _ => panic!("Unknown {} variant", stringify!(Organisationstyp)),
        }
    }
}
